...
import { BaseAfterPaymentPageProps, SubscriptionOnboardingAPData, OnboardingStep } from '../../types';
import Card from '../../components/common/Card';

const SubscriptionOnboardingDisplay: React.FC<BaseAfterPaymentPageProps<SubscriptionOnboardingAPData>> = ({ sessionData, templateData, theme, environment }) => {
  ...
  return (
    <div className={`min-h-screen ${theme.bgClass} ${theme.textClass} py-8 px-4 flex flex-col items-center`}>
      <Card className={`${theme.cardBgClass} p-6 sm:p-8 shadow-2xl max-w-lg w-full`}>
        ...
        <h2 className={`text-xl font-semibold mb-4 text-center ${accentColorClass}`}>{templateData.onboardingHeadline}</h2>
...
export default SubscriptionOnboardingDisplay;
