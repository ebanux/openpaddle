...
import { BaseAfterPaymentPageProps, MonetizationUseCase, SubscriptionReferralAPData } from '../../types';
import Card from '../../components/common/Card';
import Button from '../../components/common/Button';
import MembershipPassQR from '../../components/common/MembershipPassQR';

const SubscriptionReferralDisplay: React.FC<BaseAfterPaymentPageProps<SubscriptionReferralAPData>> = ({ sessionData, templateData, theme, environment }) => {
  ...
  return (
    <div className={`min-h-screen ${theme.bgClass} ${theme.textClass} py-8 px-4 flex flex-col items-center`}>
      <Card className={`${theme.cardBgClass} p-6 sm:p-8 shadow-2xl max-w-lg w-full text-center`}>
        ...
        {sessionData.useCase === MonetizationUseCase.MEMBERSHIP_ACCESS && (templateData as any).showPassQRCode && (
...
export default SubscriptionReferralDisplay;
